...
from core.algorithms.onpolicy_sync.losses import PPO, RotationPred
...
from projects.pointnav_baselines.models.point_nav_models import (
    ...
    ResnetTensorModelAuxPointNavActorCritic,
)
...
class PointNavRoboThorRGBPPOExperimentConfig(ExperimentConfig):
    ...
    def __init__(self):
        ...
        self.TRAIN_GPU_IDS = list(range(8))
    ...
    @classmethod
    def tag(cls):
        return "Pointnav-S2S-RoboTHOR-Sep-Rot-Pred-RGB-ResNet-DDPPO"
    ...
    def training_pipeline(self, **kwargs):
        ...
        num_mini_batch = 1
        update_repeats = 4
        num_steps = 128  # Trying with rollout step-size of 128 on GPUs with more memory
    ...
    def create_model(cls, **kwargs) -> nn.Module:
        return ResnetTensorModelAuxPointNavActorCritic(
