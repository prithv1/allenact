    ...
    def monkey_patch_datasets(self, train_dataset, val_dataset, test_dataset):
        if train_dataset is not None:
            ...
            self.TRAIN_DATASET_DIR = os.path.join(
                os.getcwd(), "datasets/robothor-pointnav/calib_val_0.4_per_sc"
            )
