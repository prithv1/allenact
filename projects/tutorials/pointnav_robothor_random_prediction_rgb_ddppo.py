...
from core.algorithms.onpolicy_sync.losses import RandomPred
from core.algorithms.onpolicy_sync.losses.ppo import PPOConfig
from core.algorithms.onpolicy_sync.losses.random_pred import RandomPredConfig
...
class PointNavRoboThorRGBPPOExperimentConfig(ExperimentConfig):
    ...
    @classmethod
    def tag(cls):
        return "PointNavRobothorRGBPPORandomPrediction"
    ...
    def training_pipeline(cls, **kwargs):
        ...
        return TrainingPipeline(
            ...
            named_losses={
                ...
                "random_pred_loss": Builder(
                    RandomPred, kwargs={}, default=RandomPredConfig
                ),
            },
            gamma=gamma,
            use_gae=use_gae,
            ...
            pipeline_stages=[
                PipelineStage(
                    loss_names=["ppo_loss", "random_pred_loss"],
                    max_stage_steps=ppo_steps,
                    loss_weights=[1.0, 0.002],
                )
            ],
