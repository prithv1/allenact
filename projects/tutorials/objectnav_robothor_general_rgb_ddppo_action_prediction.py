...
from core.algorithms.onpolicy_sync.losses import ActionPred
from core.algorithms.onpolicy_sync.losses.ppo import PPOConfig
from core.algorithms.onpolicy_sync.losses.action_pred import ActPredConfig
from projects.objectnav_baselines.models.object_nav_models import (
    ResnetTensorObjectNavActorCritic,
)
from plugins.robothor_plugin.robothor_sensors import (
    RGBSensorRoboThor,
    GoalObjectTypeRoboThorSensor,
)
...
class ObjectNavRoboThorRGBPPOExperimentConfig(ExperimentConfig):
    ...
    NUM_ROLLOUT_STEPS = 30  # Number of steps to gather advantage over
    ...
    #     ),
    #     GoalObjectTypeRoboThorSensor(object_types=TARGET_TYPES,),
    # ]
    ...
    def training_pipeline(cls, **kwargs):
        ...
        num_mini_batch = 1
        update_repeats = 3
        num_steps = cls.NUM_ROLLOUT_STEPS
        # num_steps = 30
        ...
        return TrainingPipeline(
            ...
            named_losses={
                ...
                "act_pred_loss": Builder(ActionPred, kwargs={}, default=ActPredConfig),
            },
            gamma=gamma,
            use_gae=use_gae,
    ...
    def monkey_patch_sensor(self, corruptions, severities, random_crop, color_jitter):
        self.SENSORS = [
            RGBSensorRoboThor(
            ...
            GoalObjectTypeRoboThorSensor(object_types=self.TARGET_TYPES,),
        ]
    ...
    def machine_params(self, mode="train", **kwargs):
        if mode == "train":
            ...
            gpu_ids = (
                []
                if not torch.cuda.is_available()
                else self.TESTING_GPUS * workers_per_device
            )
            nprocesses = (
                1
                if not torch.cuda.is_available()
            ...
            sampler_devices = self.TESTING_GPUS
            # nprocesses = 15
