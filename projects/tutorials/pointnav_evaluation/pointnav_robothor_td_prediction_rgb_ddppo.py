...
from core.algorithms.onpolicy_sync.losses import TDPred
from core.algorithms.onpolicy_sync.losses.ppo import PPOConfig
from core.algorithms.onpolicy_sync.losses.td_pred import TDPredConfig
...
class PointNavRoboThorRGBPPOExperimentConfig(ExperimentConfig):
    ...
    @classmethod
    def tag(cls):
        return "PointNavRobothorRGBPPOTDPredictionEval"
    ...
    def training_pipeline(cls, **kwargs):
        ...
        return TrainingPipeline(
            ...
            named_losses={
                ...
                "td_pred_loss": Builder(TDPred, kwargs={}, default=TDPredConfig),
            },
            gamma=gamma,
            use_gae=use_gae,
