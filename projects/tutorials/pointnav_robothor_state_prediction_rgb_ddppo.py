...
from core.algorithms.onpolicy_sync.losses import StatePred
from core.algorithms.onpolicy_sync.losses.ppo import PPOConfig
from core.algorithms.onpolicy_sync.losses.state_pred import StatePredConfig
...
class PointNavRoboThorRGBPPOExperimentConfig(ExperimentConfig):
    ...
    @classmethod
    def tag(cls):
        return "PointNavRobothorRGBPPOStatePrediction"
    ...
    def training_pipeline(cls, **kwargs):
        ...
        return TrainingPipeline(
            ...
            named_losses={
                ...
                "act_pred_loss": Builder(StatePred, kwargs={}, default=StatePredConfig),
            },
            gamma=gamma,
            use_gae=use_gae,
    ...
    def create_model(cls, **kwargs) -> nn.Module:
        return ResnetTensorPointNavActorCritic(
            ...
            goal_dims=32,
            fwd_mode=True,
            fwd_visual_mode=False,
            fwd_belief_mode=True,
        )
